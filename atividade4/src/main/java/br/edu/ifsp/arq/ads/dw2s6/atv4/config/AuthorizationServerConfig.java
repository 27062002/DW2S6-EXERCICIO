package br.edu.ifsp.arq.ads.dw2s6.atv4.config;
...
import br.edu.ifsp.arq.ads.dw2s6.atv4.security.SystemUser;
...
public class AuthorizationServerConfig {
    ...
    JWKSet jwkSet() throws Exception {
        final InputStream inputStream = new ClassPathResource("keystore/atividade7.jks").getInputStream();
    	
        final KeyStore keyStore = KeyStore.getInstance("JKS");
        keyStore.load(inputStream, "123456".toCharArray());
        
    	RSAKey rsa = RSAKey.load(keyStore, "atividade7", "123456".toCharArray());
