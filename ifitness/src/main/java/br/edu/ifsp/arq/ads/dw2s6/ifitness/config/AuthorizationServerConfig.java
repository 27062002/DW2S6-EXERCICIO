package br.edu.ifsp.arq.ads.dw2s6.ifitness.config;
...
import br.edu.ifsp.arq.ads.dw2s6.ifitness.security.SystemUser;
...
public class AuthorizationServerConfig {
    ...
    JWKSet jwkSet() throws Exception {
        final InputStream inputStream = new ClassPathResource("keystore/ifitness.jks").getInputStream();
